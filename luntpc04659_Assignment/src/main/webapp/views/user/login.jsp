    ...
    <div class="banner">
        <div class="container form-login shadow p-3 mb-5 bg-white rounded">
            ...
            <form action="${url}/luntpc04659_Assignment/user/login" method="post">
                ...
                <p>Bạn chưa có tài khoản? <a class="noAccount" href="/luntpc04659_Assignment/user/register">Đăng ký</a></p>
                <p><a href="/luntpc04659_Assignment/user/forgot-password">Quên mật khẩu?</a></p>
            </form>
        </div>
    </div>
    <!-- End form -->