...
<!-- Bootstrap core CSS -->
<link
	href="/luntpc04659_Assignment/views/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="/luntpc04659_Assignment/views/assets/css/fontawesome.css">
<link rel="stylesheet"
	href="/luntpc04659_Assignment/views/assets/css/templatemo-sixteen.css">
<link rel="stylesheet"
	href="/luntpc04659_Assignment/views/assets/css/owl.css">
...
<body>
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown"><a
							...
							aria-expanded="false"> ${sessionScope.user == '' ? 'Tài Khoản' : sessionScope.user.userId} </a>
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<c:if test="${sessionScope.user == ''}">
									<a class="dropdown-item"
										href="/luntpc04659_Assignment/user/login">Đăng Nhập</a>
								</c:if>
								<c:if test="${sessionScope.role eq 'admin'}">
									<a class="dropdown-item"
										href="/luntpc04659_Assignment/admin/ad-home">Quản trị</a>
								</c:if>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="inner-content">
						<p>
							Copyright &copy; 2023 Online Entertainment Co., Ltd. - Design: <a
								rel="nofollow noopener" href="" target="_blank">Lukky Nguyen</a>
						</p>
					</div>
				</div>
			</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Chia Sẻ Với Bạn
						Bè</h5>
	...
	<script
		src="/luntpc04659_Assignment/views/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
